...
do	-- keep local things inside
    ...
    local function inst_clean_def(inst, ...)
      inst.super:clean()
    end
    ...
    local function subclass(baseClass, name) 
      ...
      inst_stuff.clean = inst_clean_def
    ...
    function obj_inst_stuff.clean(inst) end
    ...
    function newclass(self, name, baseClass)
